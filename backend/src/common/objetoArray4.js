...
const readable = fs.createReadStream('C:/Users/crist/Downloads/ENCERRANTES/2015/AGOSTO/02.08/Encerrante191912-020815.rtf')
        ...
        if (i == 0) {
            ...
            ls.forEach((e, i) => {
                ...
                if (i == 0) {
                    ...
                    objInicio[e[0].replace(':', '').replace('.','_')] = e[e.length - 1]
                }
            })
        }
